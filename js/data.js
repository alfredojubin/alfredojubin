 ...
 *   2) Give it a unique "id" (no spaces or accents) and fill in the fields.
 *   3) Drop the real images into /images/real and point "cover",
 *      "heroImage" and "gallery" to them.
 *   4) No need to touch the HTML: the home grid and the project
 *      template render themselves from this file.
 */
